...
! function(a) {
	...
	a.laydate = function(b) {
		...
		a.style.left = e.left + (b ? 0 : c.scroll(1))+(e.width-a.offsetWidth)+ "px", d = e.bottom + a.offsetHeight / 1.5 <= c.winarea() ? e.bottom - 1 : e.top > a.offsetHeight / 1.5 ? e.top - a.offsetHeight + 1 : c.winarea() - a.offsetHeight, a.style.top = d + (b ? 0 : c.scroll()) + "px"
	}, c.follow = function(a) {
